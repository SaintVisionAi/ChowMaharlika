          ...
          {items.map((item) => (
            <article key={item.id} className="group overflow-hidden rounded-xl border border-border/60 bg-[hsl(var(--charcoal-900))] shadow-xl">
              {item.imageUrl ? (
                ...
                <div className="h-40 w-full bg-[hsl(var(--charcoal-800))]" />
              )}
              <div className="p-4">
                ...
                <div className="mt-1 text-xs text-foreground/60">{item.category || "Uncategorized"}</div>
                <button className="mt-3 w-full rounded-md border border-[hsl(var(--gold-600))]/60 bg-gradient-to-b from-[hsl(var(--gold-500))] to-[hsl(var(--gold-600))] px-4 py-2 text-sm font-semibold text-[hsl(var(--charcoal-900))] shadow-glow-gold transition hover:brightness-110">
                  Add to cart
                </button>
              </div>
            </article>
